...
export function ed25519keypair_from_bytes(a: number, b: number, c: number): void;
...
export function ed25519publickey_from_bytes(a: number, b: number, c: number): void;
...
export function ed25519publickey_new(a: number, b: number, c: number): void;
