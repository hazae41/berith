...
import * as Berith from "https://deno.land/x/ed25519_dalek@1.1.14/deno/mod.ts";
import { Ed25519Keypair, Ed25519PublicKey } from "https://deno.land/x/ed25519_dalek@1.1.14/deno/mod.ts";

Berith.initSyncBundledOnce()

Deno.bench("@hazae41/berith 1.1.14 (unserialized)", { group: "unserialized", baseline: true }, () => {
...
Deno.bench("@hazae41/berith 1.1.14 (serialized)", { group: "serialized", baseline: true }, () => {
