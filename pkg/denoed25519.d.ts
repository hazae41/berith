...
export interface InitOutput {
  ...
  readonly ed25519keypair_from_bytes: (a: number, b: number) => number;
  ...
  readonly ed25519publickey_new: (a: number, b: number) => number;
  readonly ed25519publickey_from_bytes: (a: number, b: number) => number;
  ...
  readonly ed25519signature_new: (a: number, b: number) => number;
